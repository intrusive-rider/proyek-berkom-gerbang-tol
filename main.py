...
factor = max(tol_diff + 1, 1) # Pengali harga dari jarak yang ditempuh
harga_total = factor * harga_per_gol[gol_pengguna - 1] # Harga yang harus dibayar (bayar pas masuk + keluar [jika beda ruas])
